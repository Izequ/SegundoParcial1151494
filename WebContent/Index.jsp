							...
							<div class="frontside">
								<div class="card">
									<div class="card-body text-center">
										...
										<p class="card-text">Servicio de domicilio ecológico para
											toda la ciudad</p>
							...
							<div class="backside">
								<div class="card">
									<div class="card-body text-center mt-4">
										...
										<p class="card-text">Nuestro servicio de domicilio cumple
											con todos los estandares de seguridad para garantizar la
											tranquilidad de nuestros clientes. Usamos bicicletas y
											vehiculos eléctricos alineados al cuidado del medio ambiente.
											Trabajar con nosotros es trabajar por un mejor futuro.</p>
							...
							<div class="frontside">
								<div class="card">
									<div class="card-body text-center">
										...
										<p class="card-text">Reparamos cualquier tipo de daño en
											tu hogar</p>
										<a href="https://www.fiverr.com/share/qb8D02"
											class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
									</div>
							...
							<div class="backside">
								<div class="card">
									<div class="card-body text-center mt-4">
										...
										<p class="card-text">Contamos con un servicio
											especializado de reparación de plomería y construcción para
											el hogar. Tranquilo nosotros nos preocupamos por ti.</p>
										<ul class="list-inline">
											<li class="list-inline-item"><a
												class="social-icon text-xs-center" target="_blank"
												href="https://www.fiverr.com/share/qb8D02"> <i
							...
							<div class="frontside">
								<div class="card">
									<div class="card-body text-center">
										...
										<p class="card-text">Cuidado especial para tus uñas en
											casa.</p>
										<a href="https://www.fiverr.com/share/qb8D02"
											class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
									</div>
							...
							<div class="backside">
								<div class="card">
									<div class="card-body text-center mt-4">
										...
										<p class="card-text">Este es un servicio básico en tu
											vida. Cuidamos tus uñas mientras estes en tu hogar. Contamos
											con personal especializado para tu cuidado</p>
										<ul class="list-inline">
											<li class="list-inline-item"><a
												class="social-icon text-xs-center" target="_blank"
												href="https://www.fiverr.com/share/qb8D02"> <i
